...
pub struct OutputLayerTerms { pub shared: SharedOutputTerms, pub dz_db: f64, pub dz_dw: Array2<f64>, pub bias_shape: (usize, usize)}
pub struct SharedOutputTerms { pub dc_da: Array2<f64>, pub da_dz: Array2<f64>, pub dc_dz: Option<Array2<f64>> } // last field is result
...
impl ComputeLayer {
    ...
    pub fn acc(&mut self) -> Option<Array2<f64>> { 
        match self {
            ComputeLayer::Output(l2) => return l2.shared.dc_dz.take(),
