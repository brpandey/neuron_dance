...
use crate::cost::{
    binary_cross_entropy::BinaryCrossEntropy, categorical_cross_entropy::CategoricalCrossEntropy,
    quadratic::Quadratic,
};
use crate::gradient::CombinateRule; // Update (2)
...
pub type CostCRFp =
    fn(CostDFp, Array2<f64>, ArrayView2<f64>, ActFp, Array2<f64>, Act) -> CombinateRule;
